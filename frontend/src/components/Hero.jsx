      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center perspective-[2000px]">
        ...
        >
          ...
          >
             ...
             {/* Expansion Card */}
             <div className="absolute top-0 right-[110%] w-48 p-4 glass rounded-2xl opacity-0 group-hover/badge:opacity-100 translate-x-4 group-hover/badge:translate-x-0 transition-all duration-300 pointer-events-none border border-primary/20 shadow-[0_0_30px_rgba(168,85,247,0.2)]">
                <div className="text-[10px] font-black text-primary uppercase mb-1 tracking-widest">Elite Global Rating</div>
                <div className="text-[9px] text-gray-400 leading-relaxed font-medium">Verified across 50+ high-end AI projects. Consistently rated 5-stars for architectural precision.</div>
             </div>
          </motion.div>
          ...
          >
             ...
             {/* Expansion Card */}
             <div className="absolute bottom-0 left-[110%] w-52 p-4 glass rounded-2xl opacity-0 group-hover/badge:opacity-100 -translate-x-4 group-hover/badge:translate-x-0 transition-all duration-300 pointer-events-none border border-secondary/20 shadow-[0_0_30px_rgba(99,102,241,0.2)]">
                <div className="text-[10px] font-black text-secondary uppercase mb-1 tracking-widest">Zero-Defect Record</div>
                <div className="text-[9px] text-gray-400 leading-relaxed font-medium">100% On-Time Delivery. Every line of code is stress-tested for enterprise-grade stability.</div>
             </div>
          </motion.div>
        </motion.div>
