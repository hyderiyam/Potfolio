  ...
  return (
    <section id="contact" className="py-24 sm:py-32 px-4 sm:px-6 bg-[#030014] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {/* ── Connect With Me (Shifted to Top) ── */}
        <motion.div
        ...
        >
          ...
          <StyledWrapper>
            <div className="card">
              {/* Phone containerOne (replacing Instagram) */}
              <a 
              ...
              {/* GitHub containerTwo (replacing Twitter) */}
              <a 
        ...
        {/* ── Let's Build Your Product (CTA Box) ── */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ delay: 0.1, duration: 0.6 }}
          className="bg-white/5 backdrop-blur-xl border border-white/10 shadow-[0_0_50px_rgba(168,85,247,0.1)] p-8 sm:p-16 rounded-[3rem] text-center relative overflow-hidden"
        >
          {/* Inner CTA Glow */}
