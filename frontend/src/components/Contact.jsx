  ...
  return (
    <section id="contact" className="py-24 sm:py-32 px-4 sm:px-6 bg-[#030014] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {/* Social Links via StyledWrapper */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          ...
          <StyledWrapper>
            <div className="card">
              <a href="https://github.com/hyderiyam" target="_blank" rel="noopener noreferrer" className="socialContainer containerOne">
              ...
              <a href="https://github.com/hyderiyam" target="_blank" rel="noopener noreferrer" className="socialContainer containerTwo">
              ...
              <a href="https://www.linkedin.com/in/syed-hyder-abbas-73b851230" target="_blank" rel="noopener noreferrer" className="socialContainer containerThree">
                <svg className="socialSvg linkdinSvg" viewBox="0 0 448 512">
                  <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" />
                </svg>
              </a>
              <a href="https://wa.me/923287172397" target="_blank" rel="noopener noreferrer" className="socialContainer containerFour">
...
const StyledWrapper = styled.div`
  ...
  .containerThree:hover {
    ...
    transform: scale(1.35) translateY(-5px);
    border-radius: 15px;
    box-shadow: 0 10px 20px rgba(0, 114, 177, 0.3);
  }
  /* Whatsapp*/
  .containerFour:hover {
